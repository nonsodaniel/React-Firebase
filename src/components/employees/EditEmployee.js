...
class EditEmployee extends Component {
  ...
  componentDidMount() {
    ...
    let base_url = 'http://owhnonso.herokuapp.com/api';
    // isDev ? "http://localhost:4000/api" : "www.acadatrends.com/api"
    ...
    fetch(`${base_url}/admin/${id}`)
      ...
      .then(employeeData => {
        ...
        console.log('yes', employeeData.data);
                  ...
                  <button
                    className={
                      this.state.isLoading
                        ? 'mb-2 btn btn-primary mr-2 col-md-12 disabled'
                        : 'mb-2 btn btn-primary mr-2 col-md-12'
                    }
                  >
                    {this.state.isLoading
                      ? 'Updating category...'
