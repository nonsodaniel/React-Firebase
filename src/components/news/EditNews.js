        ...
        fetch(`${base_url}/news/${id}`, {
            ...
            res.json().then((response) => {
                ...
                if (response.statuscode === 200) {
                    ...
                    setTimeout(this.props.history.push('/view-news'), 2000)
                    ...
                    <div className="container" style={{ background: "white", height: "auto" }}><br /><br />
                        ...
                        <form className="form-group" onSubmit={this.handleSubmit}>
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-8">
                                    <textarea type="text" wrap="on" className="form-control" value={state ? state.content : ""} id="content" rows="3" placeholder="News Content" onChange={this.handleChange}></textarea>
